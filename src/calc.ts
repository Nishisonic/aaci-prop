...
const LIST: Readonly<{
  ...
  2: { kind: 2, priority: 16, fixed: 6, prop: 1.7, value: 55 },
  3: { kind: 3, priority: 26, fixed: 4, prop: 1.6, value: 50 },
  4: { kind: 4, priority: 15, fixed: 6, prop: 1.5, value: 52 },
  5: { kind: 5, priority: 27, fixed: 4, prop: 1.5, value: 50 },
  ...
  25: { kind: 25, priority: 10, fixed: 7, prop: 1.55, value: 60 },
  ...
  32: { kind: 32, priority: 39, fixed: 3, prop: 1.2, value: 51 },
  33: { kind: 33, priority: 31, fixed: 3, prop: 1.35, value: 44 },
  34: { kind: 34, priority: 12, fixed: 7, prop: 1.6, value: 56 },
  35: { kind: 35, priority: 17, fixed: 6, prop: 1.55, value: 53 },
  36: { kind: 36, priority: 18, fixed: 6, prop: 1.55, value: 53 },
  37: { kind: 37, priority: 30, fixed: 4, prop: 1.45, value: 44 },
  38: { kind: 38, priority: 1, fixed: 10, prop: 1.85, value: 59 },
  39: { kind: 39, priority: 2, fixed: 10, prop: 1.7, value: 56 },
  40: { kind: 40, priority: 3, fixed: 10, prop: 1.7, value: 55 },
  41: { kind: 41, priority: 5, fixed: 9, prop: 1.65, value: 54 },
  ...
  46: { kind: 46, priority: 8, fixed: 8, prop: 1.55, value: 60 },
};
